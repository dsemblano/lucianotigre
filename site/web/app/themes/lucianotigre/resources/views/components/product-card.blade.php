...
<div class="group not-prose bg-white rounded-2xl shadow hover:shadow-lg transition overflow-hidden">
  ...
  <div class="p-5 space-y-3">
    ...
    {{-- TITLE --}}
    <h3 class="text-lg font-semibold leading-tight text-primary">
    ...
    <div class="flex items-center justify-between pt-3">
      ...
      <a
        ...
        class="px-4 py-2 bg-primary hover:bg-emerald-800 text-white rounded-lg text-sm font-semibold transition"
      >
        Comprar
      </a>
    </div>
