<div x-data="{ mobileOpen: false }" class="relative" x-cloak>
    ...
    <ul class="hidden lg:flex justify-start text-base font-heading gap-6">
    ...
    <button @click.stop="mobileOpen = !mobileOpen" class="lg:hidden p-2 relative w-10 h-10 z-50 left-0 top-0"
